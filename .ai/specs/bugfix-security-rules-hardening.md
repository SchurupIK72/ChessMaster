...
### Текущий статус
- Этап 2 завершён: `move` payload сокращён до входных параметров действия, move history и terminal transitions нормализуются на сервере.
- Следующий шаг: реализовать этап 3 через `spec-implementer`.
